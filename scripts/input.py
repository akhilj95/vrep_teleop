...
from vrep_teleop import Joints
import numpy as np
...
class recordData:
    ...
    def __init__(self):
        ...
        self.effort = []
        self.ts = []
        self.f1 = open("/home/akhiljohn/box_30_15_15/turnDemoMaster12txt", "w+")
        self.f2 = open("/home/akhiljohn/box_30_15_15/turnDemoSlave12.txt", "w+")
